...
public interface CaseCommentMapper {
    ...
    @Select("SELECT a.*, b.name, b.nick_name, b.user_pic, b.authen_status, b.company FROM case_comment a,user_info b WHERE a.user_id = b.id and case_id = #{case_id} order by a.created_at DESC")
