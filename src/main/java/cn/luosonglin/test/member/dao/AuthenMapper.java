...
public interface AuthenMapper {
    ...
    @Insert("INSERT INTO authen(user_id, user_type, authen_status, state_date, moblie_phone, user_name, user_title, user_department, user_hospital) VALUES(#{userId}, #{userType}, #{authenStatus}, #{stateDate}, #{mobliePhone}, #{userName}, #{userTitle}, #{userDepartment}, #{userHospital})")
